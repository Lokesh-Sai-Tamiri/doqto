      ...
      <main className="bg-dark min-h-screen pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-10">
            ...
            <h3 className="text-white font-medium mb-2 mt-6">Usage Data</h3>
            <ul className="list-disc list-inside text-gray-400 space-y-2 ml-4">
              <li>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc list-inside text-gray-400 space-y-2 ml-4">
              ...
              <li>
                <span className="text-white">Legal requirements:</span> When
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc list-inside text-gray-400 space-y-2 ml-4">
              <li>
                <span className="text-white">Access:</span> Request a copy of
                the personal information we hold about you
              </li>
              <li>
                <span className="text-white">Correction:</span> Request that we
                correct inaccurate or incomplete information
              </li>
              <li>
                <span className="text-white">Deletion:</span> Request that we
                delete your personal information, subject to legal retention
                requirements
              </li>
              <li>
                <span className="text-white">Portability:</span> Request a copy
                of your data in a structured, machine-readable format
              </li>
              <li>
                <span className="text-white">Restriction:</span> Request that
                we limit how we use your information
              </li>
              <li>
                <span className="text-white">HIPAA rights:</span> If applicable,
