    ...
    <div className="flex flex-col h-full bg-dark text-white">
      ...
      <div className="flex-1 overflow-hidden px-3 py-4 space-y-3">
        ...
        <div className="flex justify-end">
          <div className="max-w-[85%] bg-primary text-black rounded-2xl rounded-tr-sm px-3.5 py-2.5">
            <p className="text-[11px] leading-relaxed">
              I&apos;ll check right away. Initial troponin was 0.4 ng/mL — ordering a repeat and echo.
            </p>
            <div className="flex items-center justify-end gap-1 mt-1">
              <span className="text-[8px] text-black/50">9:34 AM</span>
              <svg className="w-3 h-3 text-black/50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
        ...
        <div className="flex justify-end">
          <div className="max-w-[85%] bg-primary text-black rounded-2xl rounded-tr-sm px-3.5 py-2.5">
            ...
            <div className="flex items-center justify-end gap-1 mt-1">
              <span className="text-[8px] text-black/50">9:38 AM</span>
              <svg className="w-3 h-3 text-black/50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
                <polyline points="20 6 9 17 4 12" />
              </svg>
            </div>
